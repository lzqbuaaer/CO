...
#endif
static const char *ng0 = "D:/lzq123/co/P6/mips/npc.v";
...
LAB60:    t171 = ((char*)((ng3)));
    ...
    *((unsigned int *)t184) = t193;
    ...
    t195 = *((char **)t194);
    memset(t196, 0, 8);
    xsi_vlog_unsigned_add(t196, 32, t170, 32, t195, 32);
    t194 = ((char*)((ng6)));
    memset(t197, 0, 8);
    xsi_vlog_unsigned_add(t197, 32, t196, 32, t194, 32);
    goto LAB61;
...
LAB70:    *((unsigned int *)t206) = 1;

LAB72:    memset(t222, 0, 8);
    t223 = (t206 + 4);
...
LAB78:    memcpy(t243, t222, 8);

LAB79:    memset(t203, 0, 8);
    t275 = (t243 + 4);
...
LAB90:    t282 = (t203 + 4);
    t283 = *((unsigned int *)t203);
    t284 = *((unsigned int *)t282);
    t285 = (t283 || t284);
    if (t285 > 0)
        goto LAB91;

LAB92:    t314 = *((unsigned int *)t203);
    t315 = (~(t314));
    t316 = *((unsigned int *)t282);
    t317 = (t315 || t316);
    if (t317 > 0)
        goto LAB93;
...
LAB96:    if (*((unsigned int *)t203) > 0)
        goto LAB97;

LAB98:    memcpy(t202, t320, 8);

LAB99:    goto LAB63;

LAB64:    xsi_vlog_unsigned_bit_combine(t86, 32, t197, 32, t202, 32);
    goto LAB68;

LAB66:    memcpy(t86, t197, 8);
    goto LAB68;
...
LAB91:    t287 = ((char*)((ng3)));
    ...
    *((unsigned int *)t300) = t309;
    xsi_vlog_mul_concat(t298, 14, 1, t299, 1U, t302, 1);
    xsi_vlogtype_concat(t286, 32, 32, 3U, t298, 14, t288, 16, t287, 2);
    t310 = (t0 + 1208U);
    t311 = *((char **)t310);
    memset(t312, 0, 8);
    xsi_vlog_unsigned_add(t312, 32, t286, 32, t311, 32);
    t310 = ((char*)((ng6)));
    memset(t313, 0, 8);
    xsi_vlog_unsigned_add(t313, 32, t312, 32, t310, 32);
    goto LAB92;
...
LAB93:    t318 = (t0 + 1048U);
    ...
    t318 = ((char*)((ng6)));
    memset(t320, 0, 8);
    xsi_vlog_unsigned_add(t320, 32, t319, 32, t318, 32);
    goto LAB94;

LAB95:    xsi_vlog_unsigned_bit_combine(t202, 32, t313, 32, t320, 32);
    goto LAB99;

LAB97:    memcpy(t202, t313, 8);
    goto LAB99;
...
extern void work_m_00000000002176616210_3146453351_init()
{
	...
	xsi_register_didat("work_m_00000000002176616210_3146453351", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002176616210_3146453351.didat");
