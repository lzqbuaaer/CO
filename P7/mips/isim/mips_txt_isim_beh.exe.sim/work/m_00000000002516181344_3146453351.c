...
#endif
static const char *ng0 = "D:/lzq123/co/P7/mips/npc.v";
...
LAB49:    memcpy(t59, t96, 8);

LAB50:    goto LAB28;

LAB29:    xsi_vlog_unsigned_bit_combine(t21, 32, t54, 32, t59, 32);
    goto LAB33;
...
LAB66:    memcpy(t96, t143, 8);

LAB67:    goto LAB45;

LAB46:    xsi_vlog_unsigned_bit_combine(t59, 32, t91, 32, t96, 32);
    goto LAB50;

LAB48:    memcpy(t59, t91, 8);
    goto LAB50;
...
LAB59:    t127 = ((char*)((ng6)));
    ...
    *((unsigned int *)t130) = (t137 & 15U);
    t138 = *((unsigned int *)t128);
    *((unsigned int *)t128) = (t138 & 15U);
    xsi_vlogtype_concat(t126, 32, 32, 3U, t130, 4, t129, 26, t127, 2);
    goto LAB60;
...
LAB77:    memcpy(t184, t163, 8);

LAB78:    memset(t144, 0, 8);
    t216 = (t184 + 4);
...
LAB89:    t223 = (t144 + 4);
    t224 = *((unsigned int *)t144);
    t225 = *((unsigned int *)t223);
    t226 = (t224 || t225);
    if (t226 > 0)
        goto LAB90;

LAB91:    t255 = *((unsigned int *)t144);
    t256 = (~(t255));
...
LAB95:    if (*((unsigned int *)t144) > 0)
        goto LAB96;

LAB97:    memcpy(t143, t259, 8);

LAB98:    goto LAB62;

LAB63:    xsi_vlog_unsigned_bit_combine(t96, 32, t126, 32, t143, 32);
    goto LAB67;

LAB65:    memcpy(t96, t126, 8);
    goto LAB67;
...
LAB90:    t228 = ((char*)((ng6)));
    ...
    *((unsigned int *)t229) = (t237 & 65535U);
    t238 = *((unsigned int *)t230);
    *((unsigned int *)t230) = (t238 & 65535U);
    t240 = ((char*)((ng8)));
    t241 = (t0 + 1848U);
    t242 = *((char **)t241);
    memset(t243, 0, 8);
    ...
    *((unsigned int *)t241) = t250;
    xsi_vlog_mul_concat(t239, 14, 1, t240, 1U, t243, 1);
    xsi_vlogtype_concat(t227, 32, 32, 3U, t239, 14, t229, 16, t228, 2);
    t251 = (t0 + 1208U);
    t252 = *((char **)t251);
    memset(t253, 0, 8);
    xsi_vlog_unsigned_add(t253, 32, t227, 32, t252, 32);
    t251 = ((char*)((ng3)));
    memset(t254, 0, 8);
    xsi_vlog_unsigned_add(t254, 32, t253, 32, t251, 32);
    goto LAB91;
...
LAB108:    memcpy(t300, t279, 8);

LAB109:    memset(t260, 0, 8);
    t332 = (t300 + 4);
...
LAB118:    if (*((unsigned int *)t332) != 0)
        goto LAB119;

LAB120:    t339 = (t260 + 4);
    t340 = *((unsigned int *)t260);
    t341 = *((unsigned int *)t339);
    t342 = (t340 || t341);
    if (t342 > 0)
        goto LAB121;

LAB122:    t371 = *((unsigned int *)t260);
    t372 = (~(t371));
...
LAB124:    if (*((unsigned int *)t339) > 0)
        goto LAB125;

LAB126:    if (*((unsigned int *)t260) > 0)
        goto LAB127;

LAB128:    memcpy(t259, t377, 8);

LAB129:    goto LAB93;

LAB94:    xsi_vlog_unsigned_bit_combine(t143, 32, t254, 32, t259, 32);
    goto LAB98;

LAB96:    memcpy(t143, t254, 8);
    goto LAB98;
...
LAB111:    if (*((unsigned int *)t291) != 0)
        goto LAB112;

LAB113:    t301 = *((unsigned int *)t279);
...
LAB121:    t344 = ((char*)((ng6)));
    ...
    *((unsigned int *)t357) = t366;
    xsi_vlog_mul_concat(t355, 14, 1, t356, 1U, t359, 1);
    xsi_vlogtype_concat(t343, 32, 32, 3U, t355, 14, t345, 16, t344, 2);
    t367 = (t0 + 1208U);
    t368 = *((char **)t367);
    memset(t369, 0, 8);
    xsi_vlog_unsigned_add(t369, 32, t343, 32, t368, 32);
    t367 = ((char*)((ng3)));
    memset(t370, 0, 8);
    xsi_vlog_unsigned_add(t370, 32, t369, 32, t367, 32);
    goto LAB122;

LAB123:    t375 = (t0 + 1048U);
    t376 = *((char **)t375);
    t375 = ((char*)((ng3)));
    memset(t377, 0, 8);
    xsi_vlog_unsigned_add(t377, 32, t376, 32, t375, 32);
    goto LAB124;

LAB125:    xsi_vlog_unsigned_bit_combine(t259, 32, t370, 32, t377, 32);
    goto LAB129;

LAB127:    memcpy(t259, t370, 8);
    goto LAB129;
...
extern void work_m_00000000002516181344_3146453351_init()
{
	static char *pe[] = {(void *)Cont_35_0,(void *)Cont_41_1};
	xsi_register_didat("work_m_00000000002516181344_3146453351", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002516181344_3146453351.didat");
